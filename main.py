...
class MainApp(App):
    ...
    def refresh_data(self):
        ...
        if self.data:
            ...
            self.main_widget.ids.algoritmuscard.set_data({},"Наверное, ты всё сделал",False,"База данных пуста :(")
    ...
    def theme_picker_open(self):
        ...
        self.main_widget.ids.theme_label.text = self.get_theme_string()

    def get_theme_string(self):
        return "Фон: {}\nБазовый цвет: {}\nВторичный цвет: {}".format(self.theme_cls.theme_style,
